...
if __name__ == '__main__':
    ...
    for suit in suits:
        ...
        for card in cards:
            ...
            # print(card_instance)
            # print(card_instance.card_value)

    all_cards = []
    for i in deck_instance:
        k=i
        j = k['card_value']
        all_cards.append(j)
    ...
    #         for i in range(2, 10):
    #             globals()["cards_of_" +str(i)]=0
    #             if card_instance.card_value == i:
    #                 globals()["cards_of_" +str(i)] += 1
